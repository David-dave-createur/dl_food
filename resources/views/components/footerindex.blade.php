    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xxl-4">
          <h5 class="lh-lg fw-bold text-500">SUIVEZ-NOUS</h5>
          ...
          <h3 class="text-500 my-4">Recevez des offres<br />et des réductions exclusives dans votre boîte aux lettres électronique</h3>
      ...
      <div class="row flex-center pb-3">
        <div class="col-md-6 order-0">
          <p class="text-200 text-center text-md-start">Tous droits réservés &copy; D&L FOOD, 2023</p>
        </div>
